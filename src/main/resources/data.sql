...
INSERT INTO sys_user(id, username, password, real_name, phone, email, class_id, status, create_time, update_time, deleted)
...
VALUES (1, 'Java后端期中考试', 1, 1, 2, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 1 HOUR), DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 1 DAY), 60, 24, 'IN_PROGRESS', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
